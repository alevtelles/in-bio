...
export function NewPorject({ profileId }: { profileId: string }) {
  ...
  async function handleCreatedProject() {
      ...
      <Modal isOpen={isOpen} setIsOpen={setIsOpen}>
        <div className="bg-background-primary p-8 rounded-[20px] flex flex-col justify-between gap-10 ">
          ...
          <footer className="flex gap-4 justify-end">
            ...
            <Button onClick={handleCreatedProject} disabled={isCreatingProject}>
              {" "}
              Salvar{" "}
            </Button>
          </footer>
